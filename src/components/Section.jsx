...
const Section = () => {
    return (
        <div className='bg-white flex flex-col md:flex-row justify-center space-y-5 p-5 md:p-24'>
            <img src={interactive} alt="" className='hidden md:block' />
            <img src={interactive1} alt="" className='md:hidden'/>

            <div className=' block md:relative bg-white text-center h-[19rem] p-2 top-52 right-36   md:pl-16 md:pt-16'>
                <h2 className='text-5xl text-center py-5 uppercase'>  The leader in interactive VR</h2>
